...
public class TextScroll : MonoBehaviour {
	...
	string[] cutscene1Text = new string[]{"In the beginning, there were two nations, Lavaland and Iceworld.","Due to their differences, the two lands constantly argued and fought.","  x:    You Lavalanders never think before jumping to action. If you keep acting so recklessly, we'll freeze you out!", "  z:    You Iceworlders are slow and lazy. If it's a fight you want, we'll bring you an inferno!"};
