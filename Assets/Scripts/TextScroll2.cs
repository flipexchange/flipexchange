...
public class TextScroll2 : MonoBehaviour {
	...
	string[] cutscene1Text = new string[]{"Wizard: Being merged isn't that bad, is it?","  x:    Hrm. It's still a pain to be forced to switch off all the time.", "  z:    Well it's not like I enjoy letting you do all the work either!"};
